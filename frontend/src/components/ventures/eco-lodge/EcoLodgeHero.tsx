...
export function EcoLodgeHero() {
  return (
    <section className="relative min-h-screen">
      <Image
        src={ecoLodgeHero.image}
        alt={ecoLodgeHero.imageAlt}
        fill
        priority
        className="object-cover"
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-matte-black/75 via-matte-black/40 to-matte-black/25" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1400px] flex-col justify-center px-6 pt-28 pb-24 lg:px-10">
        <div className="max-w-2xl animate-fade-in lg:max-w-3xl">
          <SectionLabel light>{ecoLodgeHero.label}</SectionLabel>

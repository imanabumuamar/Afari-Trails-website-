...
export const venturesConnectConfig: ConnectPageConfig = {
  hero: {
  ...
  intro: {
    ...
    statement:
      "Afari Ventures is not a real estate play — it is a commitment to places, people, and experiences that endure.",
    body: "Whether you lead a lodge, conservation initiative, community program, or creative studio — tell us about your vision. We partner with intention, not volume.",
  },
  categories: {
    label: "Partnership Paths",
    heading: "Where we collaborate.",
    items: [
      {
        id: "hospitality",
  ...
  form: {
    label: "Ventures Inquiry",
    heading: "Share your vision",
    subtext:
      "We look forward to hearing your ideas — and exploring whether the trail aligns.",
    submitLabel: "Begin the Conversation",
    successMessage:
      "Thank you. We review every partnership inquiry with care and will reach out when there is alignment.",
    inquiryOptions: [
  ...
  direct: {
    email: "ventures@afaritrails.com",
  ...
  closing: {
    quote: "The strongest ventures are built where vision, land, and people meet.",
  },
};

export const agricultureHero = {
  ...
  heading: "Cultivating Growth in Harmony With the Land.",
  subheading:
    "Afari Trails supports agricultural initiatives that balance sustainability, community development, environmental stewardship, and long-term resilience.",
...
export const agricultureApproach = {
  label: "Our Approach",
  statement:
...
export const agricultureFocusAreas = {
  ...
  heading: "Where land, people, and future meet.",
  items: [
    {
      id: "regenerative",
...
export const agricultureCommunity = {
...
export const agriculturePartners = {
  ...
  body: "Afari Trails seeks collaborative partnerships that support resilient agricultural systems and sustainable long-term development across Africa.",
  placeholders: [
    "Local farmers",
...
export const agricultureEcosystem = {
  label: "The Afari Ecosystem",
  heading: "One vision. Many connected paths.",
  body: "Sustainable agriculture forms part of a wider vision connecting hospitality, conservation, community development, and responsible exploration — from eco lodge dining to field experiences and long-term land stewardship.",
  links: [
    { label: "Eco Lodge", href: "/ventures/eco-lodge" },
    { label: "Conservation", href: "/ventures/conservation" },
    { label: "Community", href: "/ventures/community" },
    { label: "Partner With Us", href: "/ventures/partner" },
  ],
} as const;

export const agricultureClosing = {
  quote: "The future grows from how we care for the land today.",
} as const;
